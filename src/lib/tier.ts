...
export const TIER_LIMITS: Record<Tier, {
  ...
  coach: {
    ...
    features: ['capture', 'roster', 'plans', 'report_cards', 'parent_sharing', 'sessions', 'long_session_audio', 'feature_weekly_digest', 'feature_season_momentum', 'feature_ai_reply_draft', 'feature_player_handoff', 'feature_player_trajectory'],
  },
  pro_coach: {
    maxTeams: 999,
    maxSports: 999,
