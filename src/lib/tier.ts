...
export const TIER_LIMITS: Record<Tier, {
  ...
  organization: {
    ...
    maxPlayersPerTeam: 999,
    maxAICallsPerMonth: 999999,
    features: ['capture', 'roster', 'plans', 'report_cards', 'parent_sharing', 'sessions', 'assistant', 'analytics', 'media_upload', 'custom_prompts', 'tendencies', 'multi_coach', 'org_analytics', 'custom_branding', 'curriculum_publish', 'long_session_audio', 'feature_weekly_digest', 'feature_program_pulse'],
  },
};
