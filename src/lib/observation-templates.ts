...
const SPORT_TEXT_OVERRIDES: Record<string, Partial<Record<string, string>>> = {
  ...
  baseball: {
    'pos-shooting':  'Great batting/solid contact',
    'pos-dribbling': 'Strong fielding technique',
    'pos-passing':   'Accurate throwing/relay',
    'pos-awareness': 'Smart baserunning/situational play',
    'pos-footwork':  'Quick footwork on the bases',
    'nw-shooting':   'Batting mechanics need work',
    'nw-dribbling':  'Fielding consistency off',
    'nw-passing':    'Throwing accuracy issues',
    'nw-awareness':  'Baserunning/situational awareness lacking',
    'nw-footwork':   'Footwork/footspeed needs work',
  },
  softball: {
    'pos-shooting':  'Great batting/solid contact',
    'pos-dribbling': 'Strong fielding technique',
  ...
  lacrosse: {
    'pos-shooting':  'Great shot on goal',
    'pos-dribbling': 'Strong cradling/stick skills',
    'pos-passing':   'Great passing/catching',
    'pos-awareness': 'Smart field vision/spacing',
    'pos-defense':   'Excellent ground balls/body positioning',
    'nw-shooting':   'Shot mechanics need work',
    'nw-dribbling':  'Cradling/stick skills need work',
    'nw-passing':    'Passing/catching consistency off',
    'nw-awareness':  'Field vision/spacing lacking',
    'nw-defense':    'Defensive positioning/ground balls off',
  },
};
