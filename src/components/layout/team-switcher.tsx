    ...
    <div className="space-y-2">
      ...
      {showCreate && (
        <>
          ...
          <div className="sm:hidden fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
            <div className="w-full max-w-sm rounded-2xl border border-zinc-700 bg-zinc-900 p-5 space-y-3">
              <h3 className="text-base font-semibold text-zinc-100">Create New Team</h3>
              <input
                type="text"
                ...
                className="w-full rounded-lg border border-zinc-600 bg-zinc-800 px-3 py-2.5 text-sm text-zinc-100 placeholder:text-zinc-500 focus:border-orange-500 focus:outline-none"
                autoFocus
              ...
              <select
                ...
                className="w-full rounded-lg border border-zinc-600 bg-zinc-800 px-3 py-2.5 text-sm text-zinc-100"
              >
              ...
              <div className="flex gap-2 pt-1">
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 rounded-lg bg-orange-500 px-3 py-2.5 text-sm font-medium text-white hover:bg-orange-600 disabled:opacity-50 transition-colors"
                >
                ...
                <button
                  ...
                  className="rounded-lg px-4 py-2.5 text-sm text-zinc-400 hover:text-zinc-200 transition-colors"
                >
                  Cancel
                </button>
              </div>
