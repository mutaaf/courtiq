...
export function RecordingButton({ isRecording, onToggle, disabled = false }: RecordingButtonProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <div
        className={cn(
          'text-2xl font-mono font-bold tabular-nums transition-opacity duration-300',
      ...
      <button
        ...
        className={cn(
          ...
          isRecording
            ...
            : 'bg-orange-500 shadow-[0_0_30px_rgba(249,115,22,0.3)] hover:bg-orange-600 hover:shadow-[0_0_40px_rgba(249,115,22,0.4)]'
        )}
      >
        ...
        {isRecording && (
          <>
            ...
            <span
              className="absolute inset-[-8px] animate-pulse rounded-full border-2 border-red-500/30"
            />
          </>
        )}

        {isRecording ? (
          <Square className="relative z-10 h-8 w-8 text-white" fill="white" />
        ) : (
