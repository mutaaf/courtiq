...
export function QuickTemplates({ teamId, coachId, sessionId, preselectPlayerId, sportSlug }: QuickTemplatesProps) {
  ...
  const templates = getTemplatesBySentiment(activeTab, sportSlug);
