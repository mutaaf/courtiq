...
CI judgement: three checks gate a merge — "lint", "unit-tests", and
"e2e-tests" (hardened by ticket 0006; the Playwright suite runs against a
seeded local Supabase). A red e2e-tests is a real failure, not noise.
