...
|----|-------|----------|--------|------|
| 0084 | When a free coach hits the AI quota wall on the artifact a parent just forwarded or a coach just cloned, name THAT event in the upgrade prompt — not the generic limit copy | P1 | groomed | tier |
