...
|----|-------|----------|--------|------|
| 0062 | When the coach has been capturing all season but hasn't said a single word about Maya in 8 days, nudge them with her name — not the whole roster | P1 | in-progress | capture |
