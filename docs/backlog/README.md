...
|----|-------|----------|--------|------|
| 0088 | When a coach gets the FIRST cross-coach signal of their life on SportsIQ — first clone of one of their drills, first parent reaction crossing teams, first thank-message back, first program-pulse forward — name that one moment on /home with "you matter to other coaches now" so the first viral signal becomes the activation event the product currently lets slip past | P1 | groomed | growth |
