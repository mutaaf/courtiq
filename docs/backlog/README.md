...
|----|-------|----------|--------|------|
| 0069 | After a rough game, let the coach record 30 seconds of voice on the drive home and have it become the first drill of the next practice | P1 | in-progress | capture |
