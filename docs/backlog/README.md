...
| 0087 | When a program director sees 3+ Coach-tier coaches actively shipping in their program this month, surface a contextual Organization-tier upgrade — "your program is on SportsIQ already; one upgrade unlocks the staff view" | P1 | in-progress | tier |
